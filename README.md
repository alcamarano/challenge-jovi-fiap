...
|---|---|
| Acesso à câmera bloqueado | Clique no ícone de cadeado ou de câmera na barra de endereço e permita a câmera |
| Endereço não seguro | Abra o projeto por `https` ou `localhost` (veja "Como abrir") |
| A câmera está ocupada | Feche outros programas que estejam usando a câmera |
| Nenhuma câmera encontrada | Conecte ou ative uma câmera no aparelho |
